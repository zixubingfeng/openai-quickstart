...
class LangchainAutogptConfig:
    _instance = None

    def __new__(cls):
        if cls._instance is None:
            cls._instance = super(LangchainAutogptConfig, cls).__new__(cls)
    ...
    def __getattr__(self, name):
        ...
        raise AttributeError(f"'LangchainAutogptConfig' object has no attribute '{name}'")